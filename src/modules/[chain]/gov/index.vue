...
<template>
  <div>
    <div class="tabs tabs-boxed bg-transparent mb-4 text-center">
      <button type="button" class="tab text-gray-400 uppercase" :class="{ 'tab-active': tab === '2' }" @click="changeTab('2')">{{
        $t('gov.voting')
      }}</button>
      <button type="button" class="tab text-gray-400 uppercase" :class="{ 'tab-active': tab === '3' }" @click="changeTab('3')">{{
        $t('gov.passed')
      }}</button>
      <button type="button" class="tab text-gray-400 uppercase" :class="{ 'tab-active': tab === '4' }" @click="changeTab('4')">{{
        $t('gov.rejected')
      }}</button>
    </div>
